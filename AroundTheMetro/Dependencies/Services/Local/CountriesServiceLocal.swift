...
class CountriesServiceLocal: LocalStorageService {
    ...
    func city(with name: String?) -> City? {
        switch name {
               ...
               case "Buenos_Aires": return City(name: "Buenos_Aires", metroPlanImage: #imageLiteral(resourceName: "Buenos_Aires_Map"))
               ...
               case "Saint_Petersburg": return City(name: "Saint_Petersburg", metroPlanImage: #imageLiteral(resourceName: "Saint_Petersburg_Map"))
